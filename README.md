# Setup
Run `npm install` or `yarn` to install the requirements.

Run `npm test` or `yarn test` to test your implementation.

# Tasks
## Task 1
The system syntax is made of several lines containing chunks.
...
Find the first illegal character in each corrupted line of the subsystem (input.txt). What is the total syntax error score for those errors?

## Task 2
Now, discard the corrupted lines. The remaining lines are incomplete.

Incomplete lines don't have any incorrect characters - instead, they're missing some closing characters at the end of the line. To repair the subsystem, you just need to figure out the sequence of closing characters that complete all open chunks in the line.
...
Find the completion string for each incomplete line (input.txt), score the completion strings, and sort the scores. What is the middle score?